<!DOCTYPE html><!--[if lt IE 7]>      <html class="no-js lt-ie9 lt-ie8 lt-ie7" lang=""> <![endif]--><!--[if IE 7]>         <html class="no-js lt-ie9 lt-ie8" lang=""> <![endif]--><!--[if IE 8]>         <html class="no-js lt-ie9" lang=""> <![endif]--><!--[if gt IE 8]><!--><html class="no-js" lang="zxx"><!--<![endif]--><head>
    <!--====== USEFULL META ======-->
    <meta charset="UTF-8">
    ...
    <!--====== TITLE TAG ======-->
    <title>Elicit Publishing Limited</title>

    <!--====== FAVICON ICON =======-->
    <link rel="shortcut icon" type="assets/image/ico" href="assets/images/favicon.png">
...
<body class="transparent-layer">
                    ...
                    <div class="col-md-10 col-lg-10 col-md-offset-1 col-lg-offset-1 col-sm-12 col-xs-12">
                        <div class="welcome-text text-center">
                            ...
                            <div class="subscriber-form">
                                <p>Anticipate www.elicitpublisher.com</p>
                                <!-- <form action="#">
                ...
                <div class="contact-details">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                            ...
                            <div class="single-contact">
                                <h4>Email:</h4>
                                <p><a href="/cdn-cgi/l/email-protection#adc4c3cbc2edd4c2d8dfcec2c0ddccc3d483cec2c0"><span class="__cf_email__" data-cfemail="2a43444c456a53455f584945475a4b445304494547">[email&nbsp;protected]</span></a></p>
                            </div>
                            <div class="single-contact">
                                <h4>Phone:</h4>
        ...
        <div class="right-details-content">
            ...
            <div class="footer-area dark-bg">
                <div class="footer-copyright text-center">
                    <p>Copyright © <a href="http://themeforest.net/user/bdexpert"> BDEXPERT</a> All Right Reserved.</p>
                </div>
            </div>
        </div>
    ...
    <!--====== SCRIPTS JS ======-->
    <script data-cfasync="false" src="assets/js/email-decode.min.js"></script><script src="assets/js/jquery-1.12.4.min.js"></script>
